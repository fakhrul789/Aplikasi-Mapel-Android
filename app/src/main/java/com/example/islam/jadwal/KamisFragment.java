 ...
 */
public class KamisFragment extends Fragment implements View.OnClickListener{
    public static final String hari = "kamis";
    Context context;
    ...
    private void refreshContent(){
        new Handler().postDelayed(new Runnable() {
            ...
            public void run() {
                ...
                ft.detach(KamisFragment.this).attach(KamisFragment.this).commit();
