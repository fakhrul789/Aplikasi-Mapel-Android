 ...
 */
public class RabuFragment extends Fragment  implements View.OnClickListener{
    public static final String hari = "rabu";
    Context context;
    ...
    private void refreshContent(){
        new Handler().postDelayed(new Runnable() {
            ...
            public void run() {
                ...
                ft.detach(RabuFragment.this).attach(RabuFragment.this).commit();
