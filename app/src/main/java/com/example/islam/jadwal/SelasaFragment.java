 ...
 */
public class SelasaFragment extends Fragment implements View.OnClickListener{
    public static final String hari = "selasa";
    Context context;
    ...
    private void refreshContent(){
        new Handler().postDelayed(new Runnable() {
            ...
            public void run() {
                ...
                ft.detach(SelasaFragment.this).attach(SelasaFragment.this).commit();
